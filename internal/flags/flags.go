...
//
// Global flags (-v/--verbose, -d/--debug) are recognised in two places:
//
...
//
// After either parse path, call [Resolve] to apply "debug implies verbose"
...
// Register adds the global -v/--verbose and -d/--debug flags to fs,
// bound to the package-level [Verbose] and [Debug] variables. Call this
...
// Resolve applies flag implications (debug → verbose) and configures the
